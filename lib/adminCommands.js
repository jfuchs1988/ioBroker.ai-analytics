...
async function updateCatalogEntryAdminUnlocked(
    adapter,
    { sourceId, category, room, description, valueKind, ignored, updateFrequency, dataCompleteness } = {},
) {
    validateCatalogUpdate({ sourceId, category, room, description, valueKind, ignored, updateFrequency, dataCompleteness });
