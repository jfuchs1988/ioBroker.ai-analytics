...
async function updateCatalogEntryAdminUnlocked(
    adapter,
    { sourceId, category, room, description, valueKind, ignored, updateFrequency, dataCompleteness, derivedMetricRole, derivedMetricGroupId } = {},
) {
    validateCatalogUpdate({ sourceId, category, room, description, valueKind, ignored, updateFrequency, dataCompleteness, derivedMetricRole, derivedMetricGroupId });
