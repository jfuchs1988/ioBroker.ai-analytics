    ...
    for (let batchIndex = 0; batchIndex < batches.length; batchIndex++) {
        ...
        for (const classification of classifications) {
            ...
            const entry = {
                ...
                needsReview: finalClassification.confidence === 'low',
...
module.exports = { runOnboarding, buildClassificationPrompt, parseClassificationResponse, validateClassificationResults, adapterTypeOf, buildBatches };
