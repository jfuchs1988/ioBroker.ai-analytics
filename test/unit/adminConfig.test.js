...
describe('admin configuration links and model discovery', () => {
    ...
    it('links OpenRouter and OpenCode Zen from the configuration', () => {
    ...
    it('does not show a payment link in the custom tab', () => {
        const html = fs.readFileSync(path.join(ROOT, 'admin', 'tab.html'), 'utf8');
        expect(html).to.not.include('github.com/sponsors');
    });
