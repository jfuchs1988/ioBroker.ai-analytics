...
| `dataAccess.js` | Rohdatenabruf + Aggregation über die generische History-API; loggt vor jedem Abruf silly die exakte Anfrage (Ziel-Instanz, sourceId, Zeitraum, Aggregation) zur Nachvollziehbarkeit | `getHistory`, `compareTimeframes` |
