...
- ~~Keine Konversationshistorie im Chat-Agenten~~ — **gelöst (2026-08-22):** `getRecentChatHistory` lädt bis zu zehn vorherige Nachrichten; `runAgent` übernimmt sie über `priorMessages` in den Kontext.
